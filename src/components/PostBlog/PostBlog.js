        ...
        <div className="postPick">
            <div className="textPost">
                <div className="upperInfo">
                    <input className="title link" onChange={handleChange("title")} type="text" placeholder="Title"></input>
                    <input className="category link" onChange={handleChange("category")}  type="text" placeholder="Category"></input>
                </div>
